...
### Action Strategy
This is a strategy that we can re-use quite a bit. Note: we optimize the flexability of this component by passing its constructor a delegate/action to be executed, rather than 
