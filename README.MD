...
Here is a demo video of the behavior tree system in action showcasing the behavior tree implementation in action: [YouTube video](https://youtu.be/49WsIcEQUdc)
